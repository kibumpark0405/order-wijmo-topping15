<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="주문 유형" v-model="value.orderType" :editMode="editMode" :inputUI="''"/>
            <Payment offline label="" v-model="value.payment" :editMode="editMode" @change="change"/>
            <UserId offline label="" v-model="value.userId" :editMode="editMode" @change="change"/>
        </v-card-text>
